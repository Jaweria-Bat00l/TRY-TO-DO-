...
class TodoApp(QWidget):
    def __init__(self, username, profile_picture_path=None):
        ...
        # Logo Label
        logo_label = QLabel()
        logo_pixmap = QPixmap("C:/Users/JAWERIA/Downloads/DSA Project/trytodo logo.png")
        ...
        filters = ["Sort Tasks"]  # Removed "Today tasks" filter
        self.filter_buttons = {}
        ...
        for filter_name in filters:
            ...
            """)
            filter_button.clicked.connect(lambda checked, name=filter_name: self.switch_task_view(name))
        ...
        # Task Area Layout (Same as before)
    ...
    def display_tasks(self, category):
        ...
        if category == "scheduled":
            ...
            self.scheduled_tasks.sort(key=self.get_due_date)
    ...
    def add_task(self):
        ...
        if task_text:
            ...
            # Sort tasks by due date after adding a new task
            self.scheduled_tasks.sort(key=self.get_due_date)
            self.create_task_item((task_text, self.selected_date if self.selected_date else "No due date"))
    ...
    def create_task_item(self, task_data):
     ...
     """)
        ...
        edit_button.setIcon(QIcon("C:/Users/JAWERIA/Downloads/DSA Project/edit.png"))  # Replace with your edit icon file
        ...
        delete_button.setIcon(QIcon("C:/Users/JAWERIA/Downloads/DSA Project/delete.png"))
